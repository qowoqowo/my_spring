		...
		<div class="container pt-5">
			...
			<div class="row justify-content-center">
				<div class="col-lg-8 col-xl-7">
					...
					<form action="${pageContext.request.contextPath }/photoWriteDo" method="POST" enctype="multipart/form-data">
						<div class="mb-3">
							<input class="form-control" id="inputId" type="text" name="photoTitle" placeholder="제목을 입력해주세요."/>
						</div>
						
						<div class="img-container">
							<div class="img-box">
								<b>아래 이미지를 클릭해 첨부해주세요.</b>
								<img id="contentImg" class="upload-img"src="${pageContext.request.contextPath }/assets/img/uploadImg.jpg">
								<input id="inputImg" name="imgFile" type="file" hidden="true" accept="image/*" onchange="f_sandImg()">
							</div>
						</div>	
						
						<div class="d-flex justify-content-end">
							<a class="btn btn-secondary me-2" href="${pageContext.request.contextPath }/boardPhotoView">취소</a>
