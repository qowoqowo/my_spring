...
<body id="page-top">
		...
		<div class="container pt-5">
			...
			<div class="row justify-content-center">
				<div class="col-lg-8 col-xl-7">
					...
					<form id="boardWriteForm" action="<c:url value="/boardWriteDo"/>" method="POST" enctype="multipart/form-data">
						<div class="mb-3">
							<input class="form-control" id="inputId" type="text" name="boardTitle" placeholder="제목을 입력해주세요."/>
						</div>
	
						<div class="mb-3">
							<textarea id="smartEditor" class="form-control"  rows="10" name="boardContent"></textarea>
						</div>					
						
						<!-- 파일 첨부 항목 (form 태그에 enctype 속성 추가) -->
						<div class="mb-3">
						...
						<div class="d-flex justify-content-end">
							<a class="btn btn-secondary me-2" href="<c:url value="/boardView" />">취소</a>
	...
	<script type="text/javascript">
		...
		window.onload = function(){
			...
			const v_iframe = document.querySelector('#boardWriteForm > div:nth-child(2) > iframe');
